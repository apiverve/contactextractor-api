...
namespace APIVerve\Contactextractor;
...
/**
 * Client for the Contact Extractor API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/contactextractor?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/contactextractor';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ContactextractorClient] {$message}\n";
        }
    }
}
