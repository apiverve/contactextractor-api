...
class contactextractorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/contactextractor');
        }
        ...
        this.validationRules = {"url":{"type":"string","required":true,"format":"url"},"limit":{"type":"number","required":true,"default":"5"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/contactextractor`);
        }
    }
...
module.exports = contactextractorWrapper;
