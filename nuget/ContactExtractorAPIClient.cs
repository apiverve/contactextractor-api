...
namespace APIVerve.API.ContactExtractor
{
    ...
    /// <summary>
    /// Client for the ContactExtractor API
    /// </summary>
    public class ContactExtractorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/contactextractor";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "limit", new ValidationRule { Type = "number", Required = true } }
        };
        ...
        public ContactExtractorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ContactExtractorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ContactExtractorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ContactExtractorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ContactExtractorQueryOptions options)
        {
        ...
        public ResponseObj Execute(ContactExtractorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ContactExtractorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ContactExtractorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ContactExtractorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ContactExtractorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ContactExtractorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ContactExtractorQueryOptions options)
        {
